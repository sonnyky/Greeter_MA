...
public class CvPlugin : MonoBehaviour
{
    ...
    [DllImport("FaceDetection", EntryPoint = "_Flip")]
    private static extern void _Flip(IntPtr instance, ref Color32[] rawImage, int width, int height, int angle);
    ...
    public void Flip(ref Color32[] rawImage, int width, int height, int angle)
    {
        _Flip(instance, ref rawImage, width, height, angle);
    }
}